...
export function AddEventDialog({ isOpen, onClose }: AddEventDialogProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="w-full max-w-lg bg-zinc-900 border border-white/10 rounded-sm relative overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="p-4 border-t border-white/5 bg-zinc-900 flex justify-end gap-2">
                    ...
                    <button onClick={onClose} className="px-6 py-2 bg-[#a3e635] hover:bg-[#b5f045] text-black text-xs font-bold uppercase rounded-sm shadow-[0_0_8px_#a3e635] transition-all">Save Event</button>
                </div>
            </div>
        </div>
    );
