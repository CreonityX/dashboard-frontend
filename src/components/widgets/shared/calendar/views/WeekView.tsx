            ...
            <div className="flex-1 overflow-hidden flex flex-col relative w-full">
                <div className="flex-1 overflow-auto custom-scrollbar">
                    <div className="min-w-[800px] h-full flex flex-col">
                        {/* Header */}
                        <div className="grid grid-cols-8 border-b border-white/5 bg-zinc-900/40 divide-x divide-white/5 sticky top-0 z-10">
                            <div className="p-4 text-xs font-mono text-zinc-500 text-center bg-zinc-900">GMT-5</div>
                            {weekDays.map(d => (
                                <div key={d.date} className={cn(
                                    "py-3 text-center transition-colors bg-zinc-900",
                        ...
                        {/* Grid */}
                        <div className="grid grid-cols-8 divide-x divide-white/5 relative flex-1">
                            {/* Time Column */}
                            <div>
                                {HOURS.map(h => (
