...
export function InputGroup({ label, helperText, error, className, action, icon, ...props }: InputGroupProps) {
    return (
        <div className={cn("space-y-2", className)}>
            ...
            <div className="relative">
                ...
                <input
                    className={cn(
                        "w-full bg-zinc-900/50 border border-zinc-800 rounded-sm py-2.5 text-xs text-white font-mono placeholder:text-zinc-700 outline-none transition-all duration-200 focus:border-[#a3e635]/50 focus:bg-zinc-900 focus:shadow-[0_0_10px_rgba(163,230,53,0.1)]",
