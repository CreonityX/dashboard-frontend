        ...
        <div className="relative mb-8">
            ...
            <div className="px-6 relative -mt-16 flex items-end justify-between">
                ...
                <div className="flex gap-2 mb-2">
                    <button className="p-2 border border-zinc-700 bg-zinc-900/50 hover:bg-zinc-800 text-zinc-400 hover:text-white rounded-sm transition-colors">
                    ...
                    <button className="px-4 py-2 bg-white text-black font-bold text-xs uppercase rounded-sm hover:bg-zinc-200 transition-colors">
                        Contact_Me
                    </button>
                </div>
            </div>
