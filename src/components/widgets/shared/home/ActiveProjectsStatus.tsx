...
export function ActiveProjectsStatus() {
    return (
        <div className="bg-zinc-900/40 border border-zinc-800 rounded-sm p-6 h-full flex flex-col">
            <div className="flex items-center justify-between mb-6">
                <h3 className="text-sm font-bold text-white font-display uppercase tracking-wider flex items-center gap-2">
                    <Zap className="w-4 h-4 text-blue-500" /> Active_Gigs
                </h3>
                <span className="text-[10px] text-blue-500 font-mono bg-blue-500/10 px-1.5 py-0.5 rounded-sm">3 LIVE</span>
            </div>
            ...
            <button className="w-full mt-4 py-2 border border-zinc-800 hover:bg-zinc-800 rounded-sm text-[10px] text-zinc-400 hover:text-white font-mono uppercase transition-colors flex items-center justify-center gap-1">
