...
// --- Form Components ---
export function SupportInput({ label, placeholder, type = "text" }: { label: string, placeholder?: string, type?: string }) {
    return (
        <div className="space-y-2">
            ...
            <input
                ...
                className="w-full bg-zinc-900/50 border border-zinc-800 rounded-sm px-4 py-2.5 text-xs text-white font-mono outline-none focus:border-[#a3e635]/50 transition-colors placeholder:text-zinc-700"
            />
        </div>
    );
}

export function SupportTextArea({ label, placeholder }: { label: string, placeholder?: string }) {
    return (
        <div className="space-y-2">
            <label className="text-xs font-mono text-zinc-400 font-medium uppercase">{label}</label>
            <textarea
                placeholder={placeholder}
                className="w-full bg-zinc-900/50 border border-zinc-800 rounded-sm px-4 py-2.5 text-xs text-white font-mono outline-none focus:border-[#a3e635]/50 transition-colors placeholder:text-zinc-700 min-h-[120px] resize-y"
            />
        </div>
    );
}
