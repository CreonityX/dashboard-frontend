...
export function CommunityTab() {
    return (
        <div className="max-w-5xl mx-auto pb-20 animate-in fade-in zoom-in-95 duration-500 space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 p-6 bg-gradient-to-r from-purple-500/20 to-transparent border border-purple-500/20 rounded-sm">
                <div>
                    <h2 className="text-xl font-bold text-white font-display uppercase mb-1">Creator Circle</h2>
                    <p className="text-sm text-zinc-300">Join 50,000+ creators sharing tips, feedback, and opportunities.</p>
                </div>
                <button className="px-6 py-2.5 bg-purple-500 text-white font-bold text-sm uppercase rounded-sm hover:bg-purple-600 transition-colors shadow-lg hover:shadow-purple-500/20 flex items-center gap-2">
