...
import { Avatar } from "../BrandMessagesComponents";
        ...
        <div className="hidden lg:flex w-72 flex-col border-l border-zinc-800 bg-zinc-900/40 backdrop-blur-sm h-full">
            ...
            <div className="p-6 text-center border-b border-zinc-800">
                <div className="mx-auto mb-3 flex justify-center">
                    <Avatar
                        fallback={conversation.creator.substring(0, 2).toUpperCase()}
                        size="lg"
                        online={conversation.isOnline}
                    />
                </div>
                <h3 className="text-lg font-bold text-white mb-1 font-display tracking-tight">{conversation.creator}</h3>
                <p className="text-xs text-zinc-500 font-mono">
                    {conversation.isSupport ? 'Customer Experience' : `${conversation.creatorNiche || 'Creator'} • Active`}
                </p>
